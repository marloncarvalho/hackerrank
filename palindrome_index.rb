...
# Funciona mas tem o pior desempenho de todos.
# def solution(s)
...
# Funciona e tem o melhor desempenho.
#
def solution(s)
  return -1 if s == s.reverse
...
# Funciona mas falha em desempenho com strings grandes.
# O problema é que precisamos de um "for" que percorre toda a string,
# enquanto a solução acima o "while" percorre metade do caminho do "for"
# desta solução.
#
# def solution(s)
#   s = s.split ''
